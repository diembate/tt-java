...
public class ProductResourceIT {
    ...
    private static final Integer DEFAULT_QUANTITY_PRODUCT = 1;
    private static final Integer UPDATED_QUANTITY_PRODUCT = 2;
    ...
    public static Product createEntity(EntityManager em) {
        Product product = new Product()
            ...
            .quantityProduct(DEFAULT_QUANTITY_PRODUCT);
        return product;
    }
    /**
    ...
    public static Product createUpdatedEntity(EntityManager em) {
        Product product = new Product()
            ...
            .quantityProduct(UPDATED_QUANTITY_PRODUCT);
        return product;
    }
    ...
    public void createProduct() throws Exception {
        ...
        assertThat(testProduct.getQuantityProduct()).isEqualTo(DEFAULT_QUANTITY_PRODUCT);
    }
    ...
    public void getAllProducts() throws Exception {
        ...
        restProductMockMvc.perform(get("/api/products?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].quantityProduct").value(hasItem(DEFAULT_QUANTITY_PRODUCT)));
    }
    ...
    public void getProduct() throws Exception {
        ...
        restProductMockMvc.perform(get("/api/products/{id}", product.getId()))
            ...
            .andExpect(jsonPath("$.quantityProduct").value(DEFAULT_QUANTITY_PRODUCT));
    }
    ...
    public void updateProduct() throws Exception {
        ...
        assertThat(testProduct.getQuantityProduct()).isEqualTo(UPDATED_QUANTITY_PRODUCT);
    }
